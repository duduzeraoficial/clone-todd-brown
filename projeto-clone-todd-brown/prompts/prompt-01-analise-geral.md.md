...
1. **nivel_identificado**: Preencher com número final (1-5)
...
3. **analise_desempate_n4_vs_n5**: Articular lógica da Fase 3  
   - **foco_da_mensagem_e_mecanismo**: Descrever se foco é em COMO funciona ou em QUEM o cliente é  
   - **conclusao_logica**: Explicar qual nível baseado na análise
...
{  
  "analise_todd_brown": {  
    "aprovado_por_todd_brown": true/false,  
    "justificativa_aprovacao": "[2-4 parágrafos explicando POR QUÊ seria aprovado ou reprovado, citando: 1) Nível de consciência identificado, 2) Nível de sofisticação identificado (usando análise rigorosa das 4 fases), 3) Adequação do UM ao mercado, 4) Presença/ausência de pesquisa (E1). Use evidências do briefing.]",  
      
    "framework_correto": true/false,  
    "justificativa_framework": "[2-4 parágrafos explicando se a campanha segue o framework de MUDANÇA DE CRENÇAS ou apenas faz promessas. Avalie: 1) Há agitação do problema?, 2) Invalida soluções antigas?, 3) Revela MUP (causa raiz)?, 4) Apresenta MUS (UM como solução)?. Use evidências do briefing.]"  
  }  
}
...
{  
  "analise_todd_brown": {  
    "aprovado_por_todd_brown": false,  
    "justificativa_aprovacao": "[2-4 parágrafos explicando POR QUÊ seria aprovado ou reprovado, citando: 1) Nível de consciência identificado, 2) Nível de sofisticação identificado, 3) Adequação do UM ao mercado, 4) Presença/ausência de pesquisa (E1). Use evidências do briefing.]",  
